...
for each_line in txt:     
    ...
    if each_line.find("\t") !=-1:
        ...
        each_line_max =  abs(int(max(int(a1),int(a2),int(a3),int(a4),int(a5),int(a6) )))
...
<circle cx="{}" cy="{}" r="{}" style="fill:hsl(240,100%,50%)" />\n\
<circle cx="{}" cy="{}" r="{}" style="fill:hsl(0,100%,50%)" />\n\
<circle cx="{}" cy="{}" r="{}" style="fill:hsl(240,100%,50%)" />\n\
<circle cx="{}" cy="{}" r="{}" style="fill:hsl(0,100%,50%)" />\n\
<circle cx="{}" cy="{}" r="{}" style="fill:hsl(240,100%,50%)" />\n'
.format(num1*26*2+num2*-26+104  , num2*45+120   ,  abs((int(a1)/maxnum*13))    ,\
num1*26*2+num2*-26+130  , num2*45+105   ,          abs((int(a2)/maxnum*13))    ,\
num1*26*2+num2*-26+156  , num2*45+120   ,          abs((int(a3)/maxnum*13))    ,\
num1*26*2+num2*-26+156  , num2*45+150   ,          abs((int(a4)/maxnum*13))    ,\
num1*26*2+num2*-26+130  , num2*45+165   ,          abs((int(a5)/maxnum*13))    ,\
num1*26*2+num2*-26+104  , num2*45+150   ,          abs((int(a6)/maxnum*13))     ))
