...
<circle cx="{}" cy="{}" r="{}" style="fill:hsl(0,100%,50%)" />\n\
<circle cx="{}" cy="{}" r="{}" style="fill:hsl(240,100%,50%)" />\n'
.format(num1*26*2+num2*-26+104  , num2*45+120   ,  abs((float(a1)/maxnum*13))    ,\
num1*26*2+num2*-26+130  , num2*45+105   ,          abs((float(a2)/maxnum*13))    ,\
num1*26*2+num2*-26+156  , num2*45+120   ,          abs((float(a3)/maxnum*13))    ,\
num1*26*2+num2*-26+156  , num2*45+150   ,          abs((float(a4)/maxnum*13))    ,\
num1*26*2+num2*-26+130  , num2*45+165   ,          abs((float(a5)/maxnum*13))    ,\
num1*26*2+num2*-26+104  , num2*45+150   ,          abs((float(a6)/maxnum*13))     ))
